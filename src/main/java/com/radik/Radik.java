...
public final class Radik implements ModInitializer {
	...
	public static final boolean enableGeneratorTest = false; // тестовая генерация миров.
	public static final boolean enableSurface = false; // тестовая поверхность мира
