...
public class CustomOptionListWidget extends ElementListWidget<CustomOptionListWidget.WidgetEntry> {
    ...
    private final Screen chooseScreen;
    ...
    public void addWidgets(@NotNull List<ClickableWidget> widgets) {
    ...
    public void addAll(@NotNull List<ClickableWidget> widgets) {
    ...
    protected static class WidgetEntry extends Entry<WidgetEntry> {
        ...
        @Contract("_, _, _ -> new")
        public static @NotNull WidgetEntry create(ClickableWidget firstWidget, @Nullable ClickableWidget secondWidget, Screen screen) {
        ...
        @Contract("_, _ -> new")
        public static @NotNull WidgetEntry create(List<ClickableWidget> widgets, Screen screen) {
