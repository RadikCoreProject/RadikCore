...
public class ElectrolyzerScreenHandler extends AbstractRecipeScreenHandler{
    ...
    protected ElectrolyzerScreenHandler(
...
//            @Override
//            public void populateRecipeFinder(RecipeFinder finder) {
//                ElectrolyzerScreenHandler.this.populateRecipeFinder(finder);
//            }
//
//            @Override
//            public void clear() {
...
//                return entry.material().matches(new SingleStackRecipeInput(ElectrolyzerScreenHandler.this.inventory.getStack(0)), world);
//            }
